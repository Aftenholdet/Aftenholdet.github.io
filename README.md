...
- `assets/brand/` indeholder Teknologiskolens originale logoer og banner samt LEGO-klodsens favicon. Det hvide logo bruges i headeren, farvelogoet i footeren, LEGO-klodsen som favicon og banneret til linkforhåndsvisninger på GitHub Pages.
