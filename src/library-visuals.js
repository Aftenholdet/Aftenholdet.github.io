...
export const topicVisuals = {
  ...
  vent: { image: 'assets/generated/library/blocks/vent.webp', hint: 'Giv din robot en lille pause.' },
  gentag: { image: 'assets/generated/library/blocks/gentag.webp', hint: 'Gør det igen. Og igen.' },
  'hvis-ellers': { image: 'assets/generated/library/blocks/hvis-ellers.webp', hint: 'Lad din robot vælge, hvad den gør.' },
  mapping: { hint: 'Lav ét tal om til et andet.' },
  'asynkrone-traade': { image: 'assets/generated/library/blocks/asynkrone-traade.webp', hint: 'Få flere ting til at ske samtidig.' },
